...
<body class="bg-gray-50">
    ...
    <section class="bg-gradient-to-r from-d94288 to-purple-600 text-white py-20">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <p class="text-xl md:text-2xl">منصة شاملة للمرأة العربية - كل ما تحتاجينه في مكان واحد</p>
        </div>
    </section>
    ...
    <section class="py-16">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="bg-gradient-to-br from-pink-100 to-purple-100 p-8 rounded-2xl">
    ...
    <section class="py-16 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div class="bg-gradient-to-br from-pink-50 to-purple-50 p-6 rounded-xl hover:shadow-lg transition-shadow">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-cyan-50 p-6 rounded-xl hover:shadow-lg transition-shadow">
                    <div class="text-4xl text-d94288 mb-4">
                ...
                <div class="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl hover:shadow-lg transition-shadow">
                    <div class="text-4xl text-d94288 mb-4">
                ...
                <div class="bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-xl hover:shadow-lg transition-shadow">
                    <div class="text-4xl text-d94288 mb-4">
                ...
                <div class="bg-gradient-to-br from-purple-50 to-indigo-50 p-6 rounded-xl hover:shadow-lg transition-shadow">
                    <div class="text-4xl text-d94288 mb-4">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    <div class="bg-d94288 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
