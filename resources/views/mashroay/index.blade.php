...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/mashroay-admin-colors.css') }}">
...
<body class="bg-gradient-to-br from-[#FFFFFF] to-[#E6DAC8] min-h-screen">
    ...
    <section class="bg-gradient-to-r from-[#A15DBF] to-[#8B4A9C] text-white py-24">
        <div class="max-w-7xl mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-6xl font-bold mb-6 animate-fadeInUp">💼 مشروعي</h1>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-2xl transition-all border-2 border-transparent hover:border-indigo-500">
                    ...
                    @if($idea->budget_range)<p class="text-sm text-[#A15DBF] font-semibold mb-4"><i class="fas fa-coins ml-1"></i>{{ $idea->budget_range }}</p>@endif
                    <a href="{{ route('mashroay.idea.show', $idea->id) }}" class="inline-block w-full text-center bg-gradient-to-r from-[#A15DBF] to-[#8B4A9C] text-white px-6 py-3 rounded-lg hover:from-[#8B4A9C] hover:to-[#753880] transition-all font-bold">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-all">
                    ...
                    <a href="{{ route('mashroay.advice.show', $advice->id) }}" class="text-[#A15DBF] hover:text-[#8B4A9C] font-semibold text-sm">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-gradient-to-br from-[#FFFFFF] to-[#E6DAC8] rounded-lg shadow-lg p-8 hover:shadow-2xl transition-all">
                    ...
                    <a href="{{ Storage::url($plan->template_file) }}" download class="block w-full text-center bg-gradient-to-r from-[#A15DBF] to-[#8B4A9C] text-white px-6 py-3 rounded-lg hover:from-[#8B4A9C] hover:to-[#753880] transition-all font-bold">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-all">
                    ...
                    @if($fund->provider_name)<p class="text-[#A15DBF] font-semibold mb-3">{{ $fund->provider_name }}</p>@endif
                    ...
                    @if($fund->website_url)<a href="{{ $fund->website_url }}" target="_blank" class="text-[#A15DBF] hover:text-[#8B4A9C] hover:underline text-sm">زيارة الموقع →</a>@endif
                </div>
                @endforeach
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 hover:shadow-xl transition-all border border-gray-200">
                    <div class="flex items-center mb-3">
                        <i class="fas fa-tools text-2xl text-[#A15DBF] ml-3"></i>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if($resource->resource_url)<a href="{{ $resource->resource_url }}" target="_blank" class="text-[#A15DBF] hover:text-[#8B4A9C] hover:underline text-sm">فتح →</a>@endif
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="text-center mt-12">
                <a href="{{ route('articles.index') }}" 
                   class="inline-flex items-center bg-gradient-to-r from-[#A15DBF] to-[#8B4A9C] text-white px-8 py-3 rounded-lg font-semibold hover:from-[#8B4A9C] hover:to-[#753880] transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl">
    ...
    <!-- Mashroay Interactions JavaScript -->
    <script src="{{ asset('js/mashroay-interactions.js') }}"></script>
</body>
</html>
