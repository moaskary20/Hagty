{{-- صفحة خبراء التجميل في قسم جمالي --}}
<x-filament::page>
    <div class="fi-card mb-6 p-4">
        <h3 class="text-lg font-bold mb-4">خبراء التجميل</h3>
        <!-- أزرار الإضافة -->
        <div class="flex flex-wrap gap-2 justify-end mb-4">
            <button type="button" class="fi-btn bg-pink-700 text-lg px-6 py-2" onclick="document.getElementById('addExpertForm').style.display='block'">
                + إضافة خبيرة تجميل
            </button>
        ...
        <!-- نموذج إضافة خبيرة تجميل -->
        <div id="addExpertForm" style="display:none;">
            <form method="POST" action="#" enctype="multipart/form-data" class="flex flex-col gap-2 mb-4 bg-gray-900 p-4 rounded-lg">
                <input type="text" name="name" placeholder="اسم خبيرة التجميل" class="fi-input" required>
                ...
                <div class="flex gap-2 mt-2">
                    ...
                    <button type="button" onclick="document.getElementById('addExpertForm').style.display='none'" class="fi-btn bg-gray-500 w-full">إلغاء</button>
                </div>
            </form>
        </div>
        ...
        <div id="addVideoForm" style="display:none;">
            <form method="POST" action="#" enctype="multipart/form-data" class="flex flex-col gap-2 mb-4 bg-gray-900 p-4 rounded-lg">
                ...
                <input type="text" name="expert_name" placeholder="اسم خبيرة التجميل" class="fi-input" required>
                <div class="flex gap-2 mt-2">
        ...
        <!-- جدول خبراء التجميل -->
        <div class="mt-8">
            <h4 class="text-base font-bold mb-2">قائمة خبراء التجميل</h4>
        ...
        <div class="mt-8">
            <h4 class="text-base font-bold mb-2">إعلانات الفيديو لأعمال خبراء التجميل</h4>
            <table class="fi-ta-table w-full text-center">
                <thead>
                    <tr>
                        <th>اسم الخبيرة</th>
