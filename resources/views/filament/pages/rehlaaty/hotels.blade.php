<div class="min-h-screen bg-gradient-to-br from-pink-50 to-purple-50 p-6" dir="rtl">
    ...
    <div class="bg-gradient-to-r from-pink-500 to-purple-600 text-white rounded-lg p-6 mb-8">
        <h1 class="text-3xl font-bold">الفنادق</h1>
        <p class="mt-2 text-pink-100">استعرض أفضل الفنادق، أضف أو عدل أو احذف فندقاً بسهولة</p>
    </div>
    ...
    <!-- Modal -->
    <div id="addHotelModal" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.4); z-index:9999;">
        <div style="background: linear-gradient(135deg, #ec6da9 0%, #a259c3 100%); max-width:400px; margin:10vh auto; padding:2rem; border-radius:12px; position:relative; box-shadow:0 4px 24px #ec6da955; color:#fff;">
            <h2 style="color:#fff; margin-bottom:1rem;">إضافة أو تعديل فندق</h2>
            @livewire('hotel-form')
            <span onclick="document.getElementById('addHotelModal').style.display='none';" style="position:absolute;top:10px;right:16px;cursor:pointer;font-size:22px;color:#fff;">&times;</span>
        </div>
    </div>
