<div>
    <form wire:submit.prevent="save" class="space-y-4">
        <div>
            <label class="block mb-1">اسم المخيم <span class="text-pink-500">*</span></label>
        ...
        <div>
            ...
            <input type="text" wire:model.defer="location" class="w-full rounded px-3 py-2 border focus:outline-none focus:ring-2 focus:ring-pink-400">
        ...
        <div>
            <label class="block mb-1">بيانات التواصل</label>
            <input type="text" wire:model.defer="contact" class="w-full rounded px-3 py-2 border focus:outline-none focus:ring-2 focus:ring-pink-400">
