...
use App\Filament\Resources\MostasharyVideoResource\Pages;
use App\Filament\Resources\MostasharyVideoResource\RelationManagers;
...
class MostasharyVideoResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListMostasharyVideos::route('/'),
            'create' => Pages\CreateMostasharyVideo::route('/create'),
            'edit' => Pages\EditMostasharyVideo::route('/{record}/edit'),
        ];
    }
}
