...
function animateSpecificElements() {
    // Animate eventaty-specific elements
    const eventatyCards = document.querySelectorAll('.eventaty-card, .event-card');
    eventatyCards.forEach((card, index) => {
        setTimeout(() => {
            card.style.opacity = '0';
    ...
    // Animate eventaty icons
    const eventatyIcons = document.querySelectorAll('.eventaty-icon, .fas, .fa');
    eventatyIcons.forEach((icon, index) => {
        setTimeout(() => {
