// Admin Panel Ultimate Final Interactions - التفاعلات النهائية المتقدمة
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cards.forEach((card, index) => {
        ...
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-25px) scale(1.06)';
            this.style.boxShadow = '0 50px 150px rgba(161, 93, 191, 0.4)';
        });
        
        card.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 25px 100px rgba(161, 93, 191, 0.2)';
        });
    });
    ...
    buttons.forEach(button => {
        button.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 30px 80px rgba(161, 93, 191, 0.8)';
        });
    ...
    inputs.forEach(input => {
        input.addEventListener('focus', function() {
            ...
            this.style.boxShadow = '0 0 0 12px rgba(161, 93, 191, 0.3)';
        });
    ...
    badges.forEach(badge => {
        badge.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 20px 50px rgba(161, 93, 191, 0.7)';
        });
        
        badge.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.boxShadow = '0 12px 30px rgba(161, 93, 191, 0.5)';
        });
    });
    ...
    links.forEach(link => {
        link.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-6px)';
            this.style.textShadow = '0 10px 20px rgba(161, 93, 191, 0.6)';
        });
    ...
    icons.forEach(icon => {
        icon.addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.35) rotate(25deg)';
            this.style.filter = 'drop-shadow(0 20px 40px rgba(161, 93, 191, 0.7))';
        });
    ...
    breadcrumbs.forEach(breadcrumb => {
        breadcrumb.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-6px)';
            this.style.textShadow = '0 4px 8px rgba(0, 0, 0, 0.25)';
        });
    ...
    statsCards.forEach((card, index) => {
        card.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 50px 150px rgba(161, 93, 191, 0.5)';
        });
    ...
    headings.forEach(heading => {
        heading.addEventListener('mouseenter', function() {
            ...
            this.style.textShadow = '0 10px 20px rgba(0, 0, 0, 0.25)';
        });
    ...
    forms.forEach(form => {
        form.addEventListener('submit', function() {
            ...
            if (submitButton) {
                ...
                submitButton.style.boxShadow = '0 10px 30px rgba(161, 93, 191, 0.6)';
                setTimeout(() => {
                    submitButton.style.transform = 'scale(1)';
                    submitButton.style.boxShadow = '0 15px 40px rgba(161, 93, 191, 0.5)';
                }, 600);
            }
        });
    });
    ...
    if (sidebar) {
        sidebar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '12px 0 80px rgba(161, 93, 191, 0.8)';
        });
        
        sidebar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '12px 0 70px rgba(161, 93, 191, 0.7)';
        });
    }
    ...
    if (topbar) {
        topbar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '0 10px 80px rgba(161, 93, 191, 0.7)';
        });
        
        topbar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '0 10px 70px rgba(161, 93, 191, 0.6)';
        });
    }
