...
function animateSpecificElements() {
    // Animate babies-specific elements
    const babiesCards = document.querySelectorAll('.babies-card, .section-card');
    babiesCards.forEach((card, index) => {
        setTimeout(() => {
            card.style.opacity = '0';
    ...
    // Animate babies icons
    const babiesIcons = document.querySelectorAll('.babies-icon, .fas, .fa');
    babiesIcons.forEach((icon, index) => {
        setTimeout(() => {
