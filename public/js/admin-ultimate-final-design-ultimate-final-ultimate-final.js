// Admin Panel Ultimate Final Design Ultimate Final Ultimate Final - التفاعلات النهائية المتقدمة
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cards.forEach((card, index) => {
        ...
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-50px) scale(1.18)';
            this.style.boxShadow = '0 100px 260px rgba(161, 93, 191, 0.8)';
        });
        
        card.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 50px 200px rgba(161, 93, 191, 0.3)';
        });
    });
    ...
    buttons.forEach(button => {
        button.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-20px) scale(1.35)';
            this.style.boxShadow = '0 70px 160px rgba(161, 93, 191, 1)';
        });
        
        button.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 35px 90px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    navItems.forEach(item => {
        item.addEventListener('mouseenter', function() {
            this.style.transform = 'translateX(25px) scale(1.15)';
            this.style.boxShadow = '0 45px 100px rgba(161, 93, 191, 1)';
        });
    ...
    tableRows.forEach(row => {
        row.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 45px 100px rgba(161, 93, 191, 0.7)';
        });
    ...
    inputs.forEach(input => {
        input.addEventListener('focus', function() {
            ...
            this.style.boxShadow = '0 0 0 25px rgba(161, 93, 191, 0.7)';
        });
    ...
    badges.forEach(badge => {
        ...
        badge.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.boxShadow = '0 30px 70px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    links.forEach(link => {
        link.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-18px)';
            this.style.textShadow = '0 25px 50px rgba(161, 93, 191, 1)';
        });
    ...
    icons.forEach(icon => {
        icon.addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.7) rotate(50deg)';
            this.style.filter = 'drop-shadow(0 45px 90px rgba(161, 93, 191, 1))';
        });
        
        icon.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1) rotate(0deg)';
            this.style.filter = 'drop-shadow(0 25px 50px rgba(0, 0, 0, 0.4))';
        });
    });
    ...
    breadcrumbs.forEach(breadcrumb => {
        breadcrumb.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-18px)';
            this.style.textShadow = '0 12px 25px rgba(0, 0, 0, 0.6)';
        });
    ...
    alerts.forEach(alert => {
        alert.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 50px 110px rgba(161, 93, 191, 0.7)';
        });
        
        alert.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0)';
            this.style.boxShadow = '0 45px 100px rgba(161, 93, 191, 0.4)';
        });
    });
    ...
    statsCards.forEach((card, index) => {
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-50px) scale(1.25)';
            this.style.boxShadow = '0 100px 260px rgba(161, 93, 191, 0.9)';
        });
    ...
    headings.forEach(heading => {
        heading.addEventListener('mouseenter', function() {
            ...
            this.style.textShadow = '0 25px 50px rgba(0, 0, 0, 0.6)';
        });
        
        heading.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.textShadow = '0 25px 50px rgba(0, 0, 0, 0.5)';
        });
    });
    ...
    images.forEach(image => {
        image.addEventListener('mouseenter', function() {
            ...
            this.style.filter = 'brightness(1.6) contrast(1.6)';
        });
    ...
    forms.forEach(form => {
        form.addEventListener('submit', function() {
            ...
            if (submitButton) {
                submitButton.style.transform = 'scale(0.4)';
                submitButton.style.boxShadow = '0 25px 60px rgba(161, 93, 191, 1)';
                setTimeout(() => {
                    submitButton.style.transform = 'scale(1)';
                    submitButton.style.boxShadow = '0 35px 90px rgba(161, 93, 191, 0.6)';
                }, 1100);
            }
        });
    });
    ...
    if (sidebar) {
        sidebar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '25px 0 140px rgba(161, 93, 191, 1)';
        });
        
        sidebar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '22px 0 130px rgba(161, 93, 191, 0.9)';
        });
    }
    ...
    if (topbar) {
        topbar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '0 25px 140px rgba(161, 93, 191, 1)';
        });
        
        topbar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '0 20px 130px rgba(161, 93, 191, 0.8)';
        });
    }
    ...
    console.log('Admin Panel Ultimate Final Design Ultimate Final Ultimate Final Interactions Loaded Successfully!');
});
