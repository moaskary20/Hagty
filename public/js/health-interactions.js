...
function animateSpecificElements() {
    // Animate health-specific elements
    const healthCards = document.querySelectorAll('.health-card, .section-card');
    ...
    // Animate health icons
    const healthIcons = document.querySelectorAll('.health-icon, .fas, .fa');
