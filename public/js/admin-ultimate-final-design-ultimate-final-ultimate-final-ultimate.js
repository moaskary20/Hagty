// Admin Panel Ultimate Final Design Ultimate Final Ultimate Final Ultimate - التفاعلات النهائية المتقدمة
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cards.forEach((card, index) => {
        ...
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-55px) scale(1.2)';
            this.style.boxShadow = '0 110px 280px rgba(161, 93, 191, 0.9)';
        });
        
        card.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 55px 220px rgba(161, 93, 191, 0.3)';
        });
    });
    ...
    buttons.forEach(button => {
        button.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-25px) scale(1.4)';
            this.style.boxShadow = '0 80px 180px rgba(161, 93, 191, 1)';
        });
        
        button.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 40px 100px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    navItems.forEach(item => {
        item.addEventListener('mouseenter', function() {
            this.style.transform = 'translateX(28px) scale(1.18)';
            this.style.boxShadow = '0 50px 110px rgba(161, 93, 191, 1)';
        });
    ...
    tableRows.forEach(row => {
        row.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 50px 110px rgba(161, 93, 191, 0.8)';
        });
    ...
    inputs.forEach(input => {
        input.addEventListener('focus', function() {
            ...
            this.style.boxShadow = '0 0 0 28px rgba(161, 93, 191, 0.8)';
        });
    ...
    modals.forEach(modal => {
        modal.addEventListener('show', function() {
            ...
            this.style.transform = 'scale(0.02)';
    ...
    badges.forEach(badge => {
        ...
        badge.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.boxShadow = '0 35px 80px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    links.forEach(link => {
        link.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-20px)';
            this.style.textShadow = '0 30px 60px rgba(161, 93, 191, 1)';
        });
    ...
    icons.forEach(icon => {
        icon.addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.8) rotate(55deg)';
            this.style.filter = 'drop-shadow(0 50px 100px rgba(161, 93, 191, 1))';
        });
        
        icon.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1) rotate(0deg)';
            this.style.filter = 'drop-shadow(0 30px 60px rgba(0, 0, 0, 0.4))';
        });
    });
    ...
    breadcrumbs.forEach(breadcrumb => {
        breadcrumb.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-20px)';
            this.style.textShadow = '0 15px 30px rgba(0, 0, 0, 0.7)';
        });
    ...
    alerts.forEach(alert => {
        alert.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 55px 120px rgba(161, 93, 191, 0.8)';
        });
        
        alert.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0)';
            this.style.boxShadow = '0 50px 110px rgba(161, 93, 191, 0.4)';
        });
    });
    ...
    statsCards.forEach((card, index) => {
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-55px) scale(1.3)';
            this.style.boxShadow = '0 110px 280px rgba(161, 93, 191, 1)';
        });
    ...
    headings.forEach(heading => {
        heading.addEventListener('mouseenter', function() {
            ...
            this.style.textShadow = '0 30px 60px rgba(0, 0, 0, 0.7)';
        });
        
        heading.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.textShadow = '0 30px 60px rgba(0, 0, 0, 0.6)';
        });
    });
    ...
    images.forEach(image => {
        image.addEventListener('mouseenter', function() {
            ...
            this.style.filter = 'brightness(1.7) contrast(1.7)';
        });
    ...
    forms.forEach(form => {
        form.addEventListener('submit', function() {
            ...
            if (submitButton) {
                submitButton.style.transform = 'scale(0.3)';
                submitButton.style.boxShadow = '0 30px 70px rgba(161, 93, 191, 1)';
                setTimeout(() => {
                    submitButton.style.transform = 'scale(1)';
                    submitButton.style.boxShadow = '0 40px 100px rgba(161, 93, 191, 0.6)';
                }, 1200);
            }
        });
    });
    ...
    sections.forEach(section => {
        section.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-18px)';
            this.style.boxShadow = '0 50px 110px rgba(161, 93, 191, 0.8)';
        });
    ...
    if (sidebar) {
        sidebar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '28px 0 150px rgba(161, 93, 191, 1)';
        });
        
        sidebar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '25px 0 140px rgba(161, 93, 191, 0.9)';
        });
    }
    ...
    if (topbar) {
        topbar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '0 28px 150px rgba(161, 93, 191, 1)';
        });
        
        topbar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '0 25px 140px rgba(161, 93, 191, 0.8)';
        });
    }
    ...
    console.log('Admin Panel Ultimate Final Design Ultimate Final Ultimate Final Ultimate Interactions Loaded Successfully!');
});
