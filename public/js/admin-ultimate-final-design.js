// Admin Panel Ultimate Final Design - التفاعلات النهائية المتقدمة
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cards.forEach((card, index) => {
        ...
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-30px) scale(1.08)';
            this.style.boxShadow = '0 60px 180px rgba(161, 93, 191, 0.45)';
        });
        
        card.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 30px 120px rgba(161, 93, 191, 0.25)';
        });
    });
    ...
    buttons.forEach(button => {
        button.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-10px) scale(1.18)';
            this.style.boxShadow = '0 35px 90px rgba(161, 93, 191, 0.9)';
        });
        
        button.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 18px 50px rgba(161, 93, 191, 0.55)';
        });
    });
    ...
    navItems.forEach(item => {
        item.addEventListener('mouseenter', function() {
            this.style.transform = 'translateX(15px) scale(1.06)';
            this.style.boxShadow = '0 25px 60px rgba(161, 93, 191, 0.7)';
        });
    ...
    tableRows.forEach(row => {
        row.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 25px 60px rgba(161, 93, 191, 0.35)';
        });
    ...
    inputs.forEach(input => {
        input.addEventListener('focus', function() {
            ...
            this.style.boxShadow = '0 0 0 15px rgba(161, 93, 191, 0.35)';
        });
    ...
    badges.forEach(badge => {
        badge.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 25px 60px rgba(161, 93, 191, 0.8)';
        });
        
        badge.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.boxShadow = '0 15px 35px rgba(161, 93, 191, 0.55)';
        });
    });
    ...
    links.forEach(link => {
        link.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-8px)';
            this.style.textShadow = '0 12px 24px rgba(161, 93, 191, 0.7)';
        });
    ...
    icons.forEach(icon => {
        icon.addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.4) rotate(30deg)';
            this.style.filter = 'drop-shadow(0 24px 48px rgba(161, 93, 191, 0.8))';
        });
        
        icon.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1) rotate(0deg)';
            this.style.filter = 'drop-shadow(0 12px 24px rgba(0, 0, 0, 0.35))';
        });
    });
    ...
    statsCards.forEach((card, index) => {
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-30px) scale(1.12)';
            this.style.boxShadow = '0 60px 180px rgba(161, 93, 191, 0.55)';
        });
    ...
    headings.forEach(heading => {
        heading.addEventListener('mouseenter', function() {
            ...
            this.style.textShadow = '0 12px 24px rgba(0, 0, 0, 0.3)';
        });
    ...
    images.forEach(image => {
        image.addEventListener('mouseenter', function() {
            ...
            this.style.filter = 'brightness(1.3) contrast(1.3)';
        });
    ...
    forms.forEach(form => {
        form.addEventListener('submit', function() {
            ...
            if (submitButton) {
                ...
                submitButton.style.boxShadow = '0 12px 35px rgba(161, 93, 191, 0.7)';
                setTimeout(() => {
                    submitButton.style.transform = 'scale(1)';
                    submitButton.style.boxShadow = '0 18px 50px rgba(161, 93, 191, 0.55)';
                }, 700);
            }
        });
    });
    ...
    if (sidebar) {
        sidebar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '15px 0 90px rgba(161, 93, 191, 0.9)';
        });
        
        sidebar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '15px 0 80px rgba(161, 93, 191, 0.8)';
        });
    }
    ...
    if (topbar) {
        topbar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '0 12px 90px rgba(161, 93, 191, 0.8)';
        });
        
        topbar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '0 12px 80px rgba(161, 93, 191, 0.7)';
        });
    }
    ...
    console.log('Admin Panel Ultimate Final Design Interactions Loaded Successfully!');
});
