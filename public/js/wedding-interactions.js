// Wedding Section - Enhanced Interactions - تفاعلات محسنة لصفحة الزفاف
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateStats() {
        const stats = document.querySelectorAll('.grid.grid-cols-2.md\\:grid-cols-5 > div');
    ...
    function enhanceStatsClarity() {
        const stats = document.querySelectorAll('.grid.grid-cols-2.md\\:grid-cols-5 > div .text-3xl');
        stats.forEach(stat => {
        ...
        const labels = document.querySelectorAll('.grid.grid-cols-2.md\\:grid-cols-5 > div .text-sm');
