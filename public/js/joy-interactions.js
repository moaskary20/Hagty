...
function animateSpecificElements() {
    // Animate joy-specific elements
    const joyCards = document.querySelectorAll('.joy-card, .section-card');
    joyCards.forEach((card, index) => {
        setTimeout(() => {
            card.style.opacity = '0';
    ...
    // Animate joy icons
    const joyIcons = document.querySelectorAll('.joy-icon, .fas, .fa');
    joyIcons.forEach((icon, index) => {
        setTimeout(() => {
