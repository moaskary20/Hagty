// Admin Panel Ultimate Final Design Ultimate Final Ultimate - التفاعلات النهائية المتقدمة
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cards.forEach((card, index) => {
        ...
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-45px) scale(1.15)';
            this.style.boxShadow = '0 90px 240px rgba(161, 93, 191, 0.7)';
        });
        
        card.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 45px 180px rgba(161, 93, 191, 0.3)';
        });
    });
    ...
    buttons.forEach(button => {
        button.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-18px) scale(1.3)';
            this.style.boxShadow = '0 60px 140px rgba(161, 93, 191, 1)';
        });
        
        button.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 30px 80px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    navItems.forEach(item => {
        item.addEventListener('mouseenter', function() {
            this.style.transform = 'translateX(22px) scale(1.12)';
            this.style.boxShadow = '0 40px 90px rgba(161, 93, 191, 1)';
        });
    ...
    inputs.forEach(input => {
        input.addEventListener('focus', function() {
            ...
            this.style.boxShadow = '0 0 0 22px rgba(161, 93, 191, 0.6)';
        });
    ...
    badges.forEach(badge => {
        ...
        badge.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.boxShadow = '0 25px 60px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    links.forEach(link => {
        link.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-15px)';
            this.style.textShadow = '0 20px 40px rgba(161, 93, 191, 1)';
        });
    ...
    icons.forEach(icon => {
        icon.addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.6) rotate(45deg)';
            this.style.filter = 'drop-shadow(0 40px 80px rgba(161, 93, 191, 1))';
        });
        
        icon.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1) rotate(0deg)';
            this.style.filter = 'drop-shadow(0 20px 40px rgba(0, 0, 0, 0.4))';
        });
    });
    ...
    breadcrumbs.forEach(breadcrumb => {
        breadcrumb.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-15px)';
            this.style.textShadow = '0 10px 20px rgba(0, 0, 0, 0.5)';
        });
    ...
    alerts.forEach(alert => {
        alert.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 45px 100px rgba(161, 93, 191, 0.6)';
        });
        
        alert.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0)';
            this.style.boxShadow = '0 40px 90px rgba(161, 93, 191, 0.4)';
        });
    });
    ...
    statsCards.forEach((card, index) => {
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-45px) scale(1.2)';
            this.style.boxShadow = '0 90px 240px rgba(161, 93, 191, 0.8)';
        });
    ...
    headings.forEach(heading => {
        heading.addEventListener('mouseenter', function() {
            ...
            this.style.textShadow = '0 20px 40px rgba(0, 0, 0, 0.5)';
        });
        
        heading.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.textShadow = '0 20px 40px rgba(0, 0, 0, 0.4)';
        });
    });
    ...
    images.forEach(image => {
        image.addEventListener('mouseenter', function() {
            ...
            this.style.filter = 'brightness(1.5) contrast(1.5)';
        });
    ...
    forms.forEach(form => {
        form.addEventListener('submit', function() {
            ...
            if (submitButton) {
                submitButton.style.transform = 'scale(0.5)';
                submitButton.style.boxShadow = '0 20px 50px rgba(161, 93, 191, 1)';
                setTimeout(() => {
                    submitButton.style.transform = 'scale(1)';
                    submitButton.style.boxShadow = '0 30px 80px rgba(161, 93, 191, 0.6)';
                }, 1000);
            }
        });
    });
    ...
    if (sidebar) {
        sidebar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '22px 0 130px rgba(161, 93, 191, 1)';
        });
        
        sidebar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '20px 0 120px rgba(161, 93, 191, 0.9)';
        });
    }
    ...
    if (topbar) {
        topbar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '0 20px 130px rgba(161, 93, 191, 1)';
        });
        
        topbar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '0 18px 120px rgba(161, 93, 191, 0.8)';
        });
    }
    ...
    console.log('Admin Panel Ultimate Final Design Ultimate Final Ultimate Interactions Loaded Successfully!');
});
