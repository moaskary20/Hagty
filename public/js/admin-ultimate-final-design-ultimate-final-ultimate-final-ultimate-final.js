// Admin Panel Ultimate Final Design Ultimate Final Ultimate Final Ultimate Final - التفاعلات النهائية المتقدمة
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cards.forEach((card, index) => {
        ...
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-60px) scale(1.22)';
            this.style.boxShadow = '0 120px 300px rgba(161, 93, 191, 1)';
        });
        
        card.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 60px 240px rgba(161, 93, 191, 0.3)';
        });
    });
    ...
    buttons.forEach(button => {
        button.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-30px) scale(1.45)';
            this.style.boxShadow = '0 90px 200px rgba(161, 93, 191, 1)';
        });
        
        button.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 45px 110px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    navItems.forEach(item => {
        item.addEventListener('mouseenter', function() {
            this.style.transform = 'translateX(30px) scale(1.2)';
            this.style.boxShadow = '0 55px 120px rgba(161, 93, 191, 1)';
        });
    ...
    tableRows.forEach(row => {
        row.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 55px 120px rgba(161, 93, 191, 0.9)';
        });
    ...
    inputs.forEach(input => {
        input.addEventListener('focus', function() {
            this.style.transform = 'translateY(-22px)';
            this.style.boxShadow = '0 0 0 30px rgba(161, 93, 191, 0.9)';
        });
    ...
    badges.forEach(badge => {
        ...
        badge.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.boxShadow = '0 40px 90px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    links.forEach(link => {
        link.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-22px)';
            this.style.textShadow = '0 35px 70px rgba(161, 93, 191, 1)';
        });
    ...
    icons.forEach(icon => {
        icon.addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.9) rotate(60deg)';
            this.style.filter = 'drop-shadow(0 55px 110px rgba(161, 93, 191, 1))';
        });
        
        icon.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1) rotate(0deg)';
            this.style.filter = 'drop-shadow(0 35px 70px rgba(0, 0, 0, 0.4))';
        });
    });
    ...
    breadcrumbs.forEach(breadcrumb => {
        breadcrumb.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-22px)';
            this.style.textShadow = '0 18px 35px rgba(0, 0, 0, 0.8)';
        });
    ...
    alerts.forEach(alert => {
        alert.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-35px)';
            this.style.boxShadow = '0 60px 130px rgba(161, 93, 191, 0.9)';
        });
        
        alert.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0)';
            this.style.boxShadow = '0 55px 120px rgba(161, 93, 191, 0.4)';
        });
    });
    ...
    statsCards.forEach((card, index) => {
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-60px) scale(1.35)';
            this.style.boxShadow = '0 120px 300px rgba(161, 93, 191, 1)';
        });
    ...
    headings.forEach(heading => {
        heading.addEventListener('mouseenter', function() {
            ...
            this.style.textShadow = '0 35px 70px rgba(0, 0, 0, 0.8)';
        });
        
        heading.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.textShadow = '0 35px 70px rgba(0, 0, 0, 0.7)';
        });
    });
    ...
    images.forEach(image => {
        image.addEventListener('mouseenter', function() {
            ...
            this.style.filter = 'brightness(1.8) contrast(1.8)';
        });
    ...
    forms.forEach(form => {
        form.addEventListener('submit', function() {
            ...
            if (submitButton) {
                submitButton.style.transform = 'scale(0.2)';
                submitButton.style.boxShadow = '0 35px 80px rgba(161, 93, 191, 1)';
                setTimeout(() => {
                    submitButton.style.transform = 'scale(1)';
                    submitButton.style.boxShadow = '0 45px 110px rgba(161, 93, 191, 0.6)';
                }, 1300);
            }
        });
    });
    ...
    if (sidebar) {
        sidebar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '30px 0 160px rgba(161, 93, 191, 1)';
        });
        
        sidebar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '28px 0 150px rgba(161, 93, 191, 0.9)';
        });
    }
    ...
    if (topbar) {
        topbar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '0 30px 160px rgba(161, 93, 191, 1)';
        });
        
        topbar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '0 28px 150px rgba(161, 93, 191, 0.8)';
        });
    }
    ...
    console.log('Admin Panel Ultimate Final Design Ultimate Final Ultimate Final Ultimate Final Interactions Loaded Successfully!');
});
