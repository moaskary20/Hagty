// Admin Panel Ultimate Final Design Ultimate Final - التفاعلات النهائية المتقدمة
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    cards.forEach((card, index) => {
        ...
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-40px) scale(1.12)';
            this.style.boxShadow = '0 80px 220px rgba(161, 93, 191, 0.6)';
        });
        
        card.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 40px 160px rgba(161, 93, 191, 0.3)';
        });
    });
    ...
    buttons.forEach(button => {
        button.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-15px) scale(1.25)';
            this.style.boxShadow = '0 50px 120px rgba(161, 93, 191, 1)';
        });
        
        button.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0) scale(1)';
            this.style.boxShadow = '0 25px 70px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    navItems.forEach(item => {
        item.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 35px 80px rgba(161, 93, 191, 0.9)';
        });
    ...
    tableRows.forEach(row => {
        row.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 35px 80px rgba(161, 93, 191, 0.5)';
        });
    ...
    inputs.forEach(input => {
        input.addEventListener('focus', function() {
            ...
            this.style.boxShadow = '0 0 0 20px rgba(161, 93, 191, 0.5)';
        });
    ...
    badges.forEach(badge => {
        badge.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 35px 80px rgba(161, 93, 191, 1)';
        });
        
        badge.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.boxShadow = '0 20px 50px rgba(161, 93, 191, 0.6)';
        });
    });
    ...
    links.forEach(link => {
        link.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-12px)';
            this.style.textShadow = '0 18px 35px rgba(161, 93, 191, 0.9)';
        });
    ...
    icons.forEach(icon => {
        icon.addEventListener('mouseenter', function() {
            this.style.transform = 'scale(1.5) rotate(40deg)';
            this.style.filter = 'drop-shadow(0 35px 70px rgba(161, 93, 191, 1))';
        });
        
        icon.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1) rotate(0deg)';
            this.style.filter = 'drop-shadow(0 18px 35px rgba(0, 0, 0, 0.4))';
        });
    });
    ...
    breadcrumbs.forEach(breadcrumb => {
        breadcrumb.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-12px)';
            this.style.textShadow = '0 8px 15px rgba(0, 0, 0, 0.4)';
        });
    ...
    alerts.forEach(alert => {
        alert.addEventListener('mouseenter', function() {
            ...
            this.style.boxShadow = '0 40px 90px rgba(161, 93, 191, 0.5)';
        });
        
        alert.addEventListener('mouseleave', function() {
            this.style.transform = 'translateY(0)';
            this.style.boxShadow = '0 35px 80px rgba(161, 93, 191, 0.4)';
        });
    });
    ...
    statsCards.forEach((card, index) => {
        card.addEventListener('mouseenter', function() {
            this.style.transform = 'translateY(-40px) scale(1.18)';
            this.style.boxShadow = '0 80px 220px rgba(161, 93, 191, 0.7)';
        });
    ...
    headings.forEach(heading => {
        heading.addEventListener('mouseenter', function() {
            ...
            this.style.textShadow = '0 18px 35px rgba(0, 0, 0, 0.4)';
        });
        
        heading.addEventListener('mouseleave', function() {
            this.style.transform = 'scale(1)';
            this.style.textShadow = '0 18px 35px rgba(0, 0, 0, 0.35)';
        });
    });
    ...
    images.forEach(image => {
        image.addEventListener('mouseenter', function() {
            ...
            this.style.filter = 'brightness(1.4) contrast(1.4)';
        });
    ...
    forms.forEach(form => {
        form.addEventListener('submit', function() {
            ...
            if (submitButton) {
                submitButton.style.transform = 'scale(0.6)';
                submitButton.style.boxShadow = '0 18px 45px rgba(161, 93, 191, 0.9)';
                setTimeout(() => {
                    submitButton.style.transform = 'scale(1)';
                    submitButton.style.boxShadow = '0 25px 70px rgba(161, 93, 191, 0.6)';
                }, 900);
            }
        });
    });
    ...
    if (sidebar) {
        sidebar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '20px 0 120px rgba(161, 93, 191, 1)';
        });
        
        sidebar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '18px 0 110px rgba(161, 93, 191, 0.9)';
        });
    }
    ...
    if (topbar) {
        topbar.addEventListener('mouseenter', function() {
            this.style.boxShadow = '0 18px 120px rgba(161, 93, 191, 1)';
        });
        
        topbar.addEventListener('mouseleave', function() {
            this.style.boxShadow = '0 15px 110px rgba(161, 93, 191, 0.8)';
        });
    }
    ...
    console.log('Admin Panel Ultimate Final Design Ultimate Final Interactions Loaded Successfully!');
});
