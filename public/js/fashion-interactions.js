...
function animateSpecificElements() {
    // Animate fashion-specific elements
    const fashionCards = document.querySelectorAll('.fashion-card, .section-card');
    ...
    // Animate fashion icons
    const fashionIcons = document.querySelectorAll('.fashion-icon, .fas, .fa');
    fashionIcons.forEach((icon, index) => {
        setTimeout(() => {
