// Umomi Section - Enhanced Interactions - تفاعلات محسنة لصفحة أومومتي
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function animateStats() {
        const stats = document.querySelectorAll('.grid.grid-cols-1.md\\:grid-cols-3 > div');
    ...
    function enhanceStatsClarity() {
        const stats = document.querySelectorAll('.grid.grid-cols-1.md\\:grid-cols-3 > div .text-3xl');
        stats.forEach(stat => {
        ...
        const labels = document.querySelectorAll('.grid.grid-cols-1.md\\:grid-cols-3 > div .text-sm');
